...
public:
  ...
  bool  EC(Point &p);
  std::vector<Point> GeneratePoints(Int &start, Int &end);
  std::vector<Point> AddMultiple(Point &a, Point &b, int n);
  std::vector<Point> SubtractMultiple(Point &a, Point &b, int n);
